-- Update RPC to include general info fields from properties for public detail page
-- Important: we must drop the function first to change the return type (OUT params)
...
-- Reload PostgREST schema cache so clients see new function shape

...
-- ============================================================================
-- Este script adiciona os campos de métodos de pagamento e financiamento
-- na função get_public_property_detail_with_realtor para que apareçam
-- na página pública de detalhes do imóvel.
--
-- COMO USAR:
...
BEGIN
  ...
  SELECT 
    ...
    -- Campos de financiamento
    p.financing_enabled,
    p.financing_down_payment_percentage,
    p.financing_max_installments,
    p.financing_interest_rate,
    -- Campos de badge de oportunidade
    p.show_opportunity_badge,
    p.opportunity_badge_text,
    -- Campos de métodos de pagamento
    p.payment_methods_type,
    p.payment_methods_text,
    p.payment_methods_banner_url,
    -- Broker info
...
-- ============================================================================
-- VERIFICAÇÃO: Execute esta query para testar se a função está funcionando
-- ============================================================================
-- Substitua 'seu-slug-corretor' e 'slug-do-imovel' pelos valores reais:
-- 
-- SELECT * FROM get_public_property_detail_with_realtor(
--   'seu-slug-corretor',
--   'slug-do-imovel'
-- );
-- ============================================================================

...
// Componente separado para o conteúdo administrativo - só renderiza quando autorizado
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center p-12">
              ...
              <p className="text-muted-foreground text-center mb-4">
                Adicione a primeira imobiliária para começar a gerenciar o sistema.
              </p>
                    ...
                    <TableBody>
                      {brokers.map((broker) => (
                        <TableRow key={broker.id}>
                          ...
                          <TableCell className="min-w-[80px]">
                            <Badge variant="outline" className="text-xs">{broker.plan_type || 'basic'}</Badge>
                          </TableCell>
                          <TableCell className="min-w-[80px] text-sm">{broker.properties_count || 0}</TableCell>
...
export default function SuperAdminPage() {
  ...
  // ✅ VERIFICAÇÃO INICIAL SEM PISCAR
  ...
  const [showLoginDialog, setShowLoginDialog] = useState(!isAuthorized);
  ...
  // ✅ SÓ RENDERIZA AdminContent QUANDO AUTORIZADO - EVITA PISCAR
  if (!isAuthorized) {
    return (
      <div className="min-h-screen flex items-center justify-center">
  ...
  // ✅ RENDERIZA AdminContent SÓ QUANDO AUTORIZADO
  return <AdminContent />;
}
-- ========================================
-- DIAGNÓSTICO COMPLETO DO SISTEMA MULTI-TENANCY
...
-- 7. VERIFICAR RELACIONAMENTO PROPERTIES -> BROKERS (validação SuperAdmin)
SELECT 
...
-- 9. VERIFICAR FUNÇÕES RELACIONADAS AO SISTEMA
SELECT 

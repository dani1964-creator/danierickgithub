...
const sidebar_constants_1 = require("@/components/ui/sidebar-constants");
const sidebar_context_1 = require("@/components/ui/sidebar-context");
// Context and hook moved to sidebar-context.ts
const SidebarProvider = React.forwardRef(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
    ...
    const setOpen = React.useCallback((value) => {
        ...
        document.cookie = `${sidebar_constants_1.SIDEBAR_COOKIE_NAME}=${openState}; path=/; max-age=${sidebar_constants_1.SIDEBAR_COOKIE_MAX_AGE}`;
    }, [setOpenProp, open]);
    ...
    React.useEffect(() => {
        const handleKeyDown = (event) => {
            if (event.key === sidebar_constants_1.SIDEBAR_KEYBOARD_SHORTCUT &&
    ...
    return ((0, jsx_runtime_1.jsx)(sidebar_context_1.SidebarContext.Provider, { value: contextValue, children: (0, jsx_runtime_1.jsx)(tooltip_1.TooltipProvider, { delayDuration: 0, children: (0, jsx_runtime_1.jsx)("div", { style: {
                    "--sidebar-width": sidebar_constants_1.SIDEBAR_WIDTH,
                    "--sidebar-width-icon": sidebar_constants_1.SIDEBAR_WIDTH_ICON,
                    ...style,
...
const Sidebar = React.forwardRef(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
    const { isMobile, state, openMobile, setOpenMobile } = (0, sidebar_context_1.useSidebar)();
    if (collapsible === "none") {
    ...
    if (isMobile) {
        return ((0, jsx_runtime_1.jsx)(sheet_1.Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props, children: (0, jsx_runtime_1.jsx)(sheet_1.SheetContent, { "data-sidebar": "sidebar", "data-mobile": "true", className: "w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden", style: {
                    "--sidebar-width": sidebar_constants_1.SIDEBAR_WIDTH_MOBILE,
...
const SidebarTrigger = React.forwardRef(({ className, onClick, ...props }, ref) => {
    const { toggleSidebar } = (0, sidebar_context_1.useSidebar)();
...
const sidebar_variants_1 = require("@/components/ui/sidebar-variants");
const SidebarMenuButton = React.forwardRef(({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }, ref) => {
    const Comp = asChild ? react_slot_1.Slot : "button";
    const { isMobile, state } = (0, sidebar_context_1.useSidebar)();
    const button = ((0, jsx_runtime_1.jsx)(Comp, { ref: ref, "data-sidebar": "menu-button", "data-size": size, "data-active": isActive, className: (0, utils_1.cn)((0, sidebar_variants_1.sidebarMenuButtonVariants)({ variant, size }), className), ...props }));
    if (!tooltip) {
        return button;
    }

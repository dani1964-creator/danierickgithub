-- Update RPC functions to include new SEO fields

-- Drop and recreate get_public_broker_branding to include SEO fields
...
-- Drop and recreate get_public_broker_branding_secure to include SEO fields

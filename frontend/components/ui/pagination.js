...
const PaginationLink = ({ className, isActive, size = "icon", ...props }) => ((0, jsx_runtime_1.jsx)("a", { "aria-current": isActive ? "page" : undefined, className: (0, utils_1.cn)((0, button_variants_1.buttonVariants)({
